...
(() => {
  if (!runtime.packageName.equals(packageName)) {
    console.error("\u4E0D\u662F\u76EE\u6807\u5E94\u7528: ".concat(runtime.packageName));
    return;
  }
  XposedBridge.hookAllMethods(XposedHelpers.findClass("".concat(packageName, ".application.MyApplication"), runtime.classLoader), "onCreate", XC_MethodHook({
    beforeHookedMethod: function beforeHookedMethod(param) {
      var application = param.thisObject;
