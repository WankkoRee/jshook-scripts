...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$8(fn = input.toString) && !isObject$6(val = call$2(fn, input))) return val;
  if (isCallable$8(fn = input.valueOf) && !isObject$6(val = call$2(fn, input))) return val;
  if (pref !== 'string' && isCallable$8(fn = input.toString) && !isObject$6(val = call$2(fn, input))) return val;
...
var IE_BUG = DESCRIPTORS && fails$3(function () {
  // eslint-disable-next-line es/no-object-create -- safe
...
var CoreTypeN = /*#__PURE__*/function (CoreTypeN) {
  CoreTypeN[CoreTypeN["rhino"] = 1] = "rhino";
  CoreTypeN[CoreTypeN["frida"] = 2] = "frida";
  return CoreTypeN;
}({});
...
Object.entries(obj2).forEach(_ref => {
